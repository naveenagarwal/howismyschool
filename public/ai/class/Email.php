...
class Email {
    ...
    /**
     * This function is used to remove data from all pre define variable
     *
     * @param  $clear_attachments
     * @return  void
     */
    ...
    /**
     * This function is used to set sender email & name
     *
     * @param   string $from
     * @param   string $name
     * @return  void
    ...
    /**
     * This function is used to set reciever email & name
     *
    ...
    /**
     * This function is used to set reciever email id
     *
     * @param   string $to
     * @return  void
     */
    ...
    /**
     * This function is used to set CC detail
     *
     * @param   string $cc
     * @return  void
     */
    ...
    /**
     * This function is used to set BCC detail
     *
     * @param   string $bcc
     * @param   string $limit
     * @return  void
    ...
    /**
     * This function is used to set Body
     *
     * @param   string $body
     * @return  void
     */
	...
	/**
     * This function is used to check php version
     *
    ...
    /**
     * This function used to assign file attachments
     *
    ...
    /**
     * This function used to set mail header item
     *
     * @param   string $header
     * @param   string $value
     * @return  void
    ...
    /**
     * This function is used to set alternate message
     *
     * @param   string $str
     * @return  void
     */
    ...
    /**
     * This function is used to set mail type text or html
     *
     * @param   string $type
     * @return  void
     */
    ...
    /**
     * This function is used to set wordwrap as true or false
     *
    ...
    /**
     * This function is used to set mail protocol
     *
    ...
    /**
     * This function is used to set mail priority
     *
     * @param   integer $n
     * @return  void
     */
    ...
    /**
     * This function is used to define new line deliminator
     *
    ...
    /**
     * This function is used to get the message ID
     *
     * @access  protected
     * @return  string
     */
    ...
    /**
     * This function is used to get mail in encoding format
     *
     * @access  protected
     * @param   bool
     * @return  string
    ...
    /**
     * This fnction is used to set date
     *
     * @access  protected
     * @return  string
     */
    ...
    protected function _build_headers() {
        ...
        //$this->_set_header('Content-type', 'text/html; charset=iso-8859-1');
    }
    ...
    protected function _build_message() {
        ...
        switch ($this->_get_content_type()) {
            ...
            case 'plain-attach' :
                ...
                boundary=\"" . $this->_atc_boundary . "\"" . $this->newline . $this->newline;
                if ($this->_get_protocol() == 'mail') {
                    $this->_header_str .= $hdr;
                }
            ...
            case 'html-attach' :
                ...
                $body .= $this->getHTMLAttachCode();
                break;
        }
        $attachment = array();
        $z = 0;
        $ic1 = count($this->_attach_name);
        for ($i = 0; $i < $ic1; $i++) {
    ...
    public function getHTMLAttachCode(){
        $body  = $this->_get_mime_message() . $this->newline . $this->newline;
        $body .= "--" . $this->_atc_boundary . $this->newline;
    ...
    public function getPlainHTMLCode(){
        $body = $this->_get_mime_message() . $this->newline . $this->newline;
        $body .= "--" . $this->_alt_boundary . $this->newline;
        $body .= "Content-Type: text/plain; charset=" . $this->charset . $this->newline;
        $body .= "Content-Transfer-Encoding: " . $this->_get_encoding() . $this->newline . $this->newline;
    ...
    /**
     * This function is used to send SMTP command
     *
     * @param   string $cmd
     * @param   string $data
     * @return  string
    ...
    /**
     * This function is used to send SMTP data
     *
     * @return  bool
     */
    ...
    /**
     * This function is used to get SMTP data
     *
     * @return  string
     */
    ...
    /**
     * This function used to set error message
     *
     * @access  protected
     * @param   string
     * @return  string
