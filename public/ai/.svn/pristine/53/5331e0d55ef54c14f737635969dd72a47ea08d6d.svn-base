...
DEFINE('USER_MANAGEMENT_PATH', 'user-management/');
DEFINE('FRONTEND_LOGIN', USER_MANAGEMENT_PATH.'FLogin');
DEFINE('FRONTEND_LOGOUT', USER_MANAGEMENT_PATH.'FLogout');
DEFINE('FRONTEND_REGISTER', USER_MANAGEMENT_PATH.'FRegistration');

DEFINE('WALL_PATH', 'create-wall/');
DEFINE('WALL_URL', WALL_PATH.'design');
DEFINE('WALL_IMAGE_URL', WALL_PATH.'DesignImage');
...
DEFINE('SAVE_IMAGE', DESIGN_PATH.'SaveImage');

DEFINE('PRODUCT_MANAGEMENT_PATH', 'product-management/');
DEFINE('GET_PRODUCTS_PATH', PRODUCT_MANAGEMENT_PATH.'GetProducts');

DEFINE('COLOR_IMAGE_PHYSICAL_PATH', CUSTOMDIR.'/media/color');
DEFINE('COLOR_IMAGE_ROOT_PATH', URLADDR.'media/color');
DEFINE('COLOR_IMAGE_WIDTH', '160');

DEFINE('PLANT_IMAGE_PHYSICAL_PATH', CUSTOMDIR.'/media/plant');
DEFINE('PLANT_IMAGE_ROOT_PATH', URLADDR.'media/plant');
DEFINE('PLANT_IMAGE_WIDTH', '160');

DEFINE('MANUFACTURER_IMAGE_PHYSICAL_PATH', CUSTOMDIR.'/media/manufacturer');
DEFINE('MANUFACTURER_IMAGE_ROOT_PATH', URLADDR.'media/manufacturer');
DEFINE('MANUFACTURER_IMAGE_WIDTH', '160');

DEFINE('MORTAR_IMAGE_PHYSICAL_PATH', CUSTOMDIR.'/media/mortar');
DEFINE('MORTAR_IMAGE_ROOT_PATH', URLADDR.'media/mortar');
DEFINE('MORTAR_IMAGE_WIDTH', '160');

DEFINE('SIZE_IMAGE_PHYSICAL_PATH', CUSTOMDIR.'/media/size');
DEFINE('SIZE_IMAGE_ROOT_PATH', URLADDR.'media/size');
DEFINE('SIZE_IMAGE_WIDTH', '160');

DEFINE('TEXTURE_IMAGE_PHYSICAL_PATH', CUSTOMDIR.'/media/texture');
DEFINE('TEXTURE_IMAGE_ROOT_PATH', URLADDR.'media/texture');
DEFINE('TEXTURE_IMAGE_WIDTH', '160');

DEFINE('PRODUCT_IMAGE_PHYSICAL_PATH', CUSTOMDIR.'/media/product');
DEFINE('PRODUCT_IMAGE_ROOT_PATH', URLADDR.'media/product');
DEFINE('PRODUCT_IMAGE_WIDTH', '160');

DEFINE('ADD_FANCY_BOX_WIDTH', '50%');
DEFINE('ADD_FANCY_BOX_HEIGHT', '100%');
DEFINE('EDIT_FANCY_BOX_WIDTH', '50%');
DEFINE('EDIT_FANCY_BOX_HEIGHT', '100%');

DEFINE('BRICK_MANUFACTURER', 1);
DEFINE('MORTAR_MANUFACTURER', 2);
?>