...
$(function() {
    ...
    if(!$('.dashboard-content .pie-chart1').length 
    	|| !$('.dashboard-content .pie-chart2').length ){
    	$('.dashboard-content .pie-chart1').css('border','0px');
    	$('.dashboard-content .pie-chart2').css('border','0px');
    }
