...
if ($requestedScript != '' and !$missingFlag) {
	...
	$wallScriptArr = array(WALL_URL, FRONTEND_LOGIN, SAVE_DESIGN, FRONTEND_REGISTER, LIST_DESIGNS, GET_DESIGN,
	                       WALL_IMAGE_URL, SAVE_IMAGE, GET_PRODUCTS_PATH);
