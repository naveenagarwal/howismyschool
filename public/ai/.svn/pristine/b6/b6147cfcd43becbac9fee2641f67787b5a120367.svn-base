...
$delete_allowed  = $login->verify_module_access($delete_path);
 ...
 $fields_array = array(
	...
	'sorting'=>TRUE),
	'product_number'=>array('label'=>t('Product Number'),'style'=>'width:8%;',
	'sorting'=>FALSE),
	'dimension'=>array('label'=>t('Dimensions'),'style'=>'width:10%;',
	'sorting'=>FALSE),
    'manufacturer'=>array('label'=>t('Manufacturer'),'style'=>'width:12%;',
    'sorting'=>TRUE),
    'size'=>array('label'=>t('Size'),'style'=>'width:12%;',
    'sorting'=>TRUE),
    'plant'=>array('label'=>t('Plant'),'style'=>'width:12%;',
    'sorting'=>TRUE),
    'texture'=>array('label'=>t('Texture'),'style'=>'width:12%;',
    'sorting'=>TRUE),
    'color'=>array('label'=>t('Color'),'style'=>'width:12%;',
    'sorting'=>TRUE),
	'image_path'=>array('label'=>t('Image'),'style'=>'width:20%;',
	'sorting'=>FALSE),
 	'IsActive' => array('label'=>t('Active'),'style'=>'width:8%;',
	'sorting'=>TRUE)
	);

 if($edit_allowed){
     $fields_array[EDIT_OP] = array('label'=>t('Edit'),'style'=>'width:8%;',
 ...
 if($delete_allowed){
     ...
     'style'=>'width:8%;','sorting'=>FALSE,'PK_FIELD'=>'id',
     'DELETE_TYPE'=>JS_BASED,'DELETE_ACTION'=>'deleteConfirm',
 	'NO_DELETE_COLUMN' => 'id','NO_DELETE_COLUMN_VALUE'=>
     array());
 }
 $fields_array[OTHER_OP] = array('label'=>t('Duplicate'),'style'=>'width:12%;',
	'sorting'=>FALSE,'PK_FIELD'=>'id','OTHER_TYPE'=>URL_BASED,
	'OTHER_URL'=>$duplicate_path,'FIELD_LABEL'=>'Add Duplicate',
 	'NO_EDIT_COLUMN' => 'id','NO_EDIT_COLUMN_VALUE'=>array());

 $default_sort_field = 'prd.name';
