...
$edit_path       = 'plant/PlantEdit';
$delete_path     = 'plant/PlantDelete';
$add_path        = 'plant/PlantAdd';
...
$delete_allowed  = $login->verify_module_access($delete_path);
 ...
 $fields_array = array(
	...
	'sorting'=>TRUE),
	'manufacturer_name'=>array('label'=>t('Manufacturer'),'style'=>'width:20%;',
	'sorting'=>TRUE),
	'plant_longitude'=>array('label'=>t('Longitude'),'style'=>'width:10%;',
	'sorting'=>FALSE),
	'plant_latitude'=>array('label'=>t('Latitude'),'style'=>'width:10%;',
	'sorting'=>FALSE),
...
if(isset($_REQUEST['data-list']) && $_REQUEST['data-list'] == '1'){
	...
	$total_records = $plant_obj->get_total_plants($search);
	$result_set    = $plant_obj->get_plant_list($sort_order,$limit,$search);
...
$record_url = URL."plant/PlantList&ajax=1&data-list=1";
$delete_url = URL."plant/PlantDelete&ajax=1";
...
require_once('./view/plant/PlantList.php');
?>