...
ColVis.prototype = {
	...
	"_fnConstruct": function ()
	{
		...
		this.dom.button.className += " ColVis_MasterButton btn btn-success";
	...
	"_fnDrawCallback": function ()
	{
		...
		if(typeof scrollEnabled != 'undefined' && scrollEnabled){
			addJSScrollPaneDelayed(scrollEnabled)
			//addJSScrollPane(scrollEnabled);
		}
