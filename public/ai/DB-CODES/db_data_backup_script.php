...
foreach($dbArray as $db){
 ...
 $systemCall = 'mysqldump --host='.$server.' --user='.$user.' --password='.$password.' --port='.$port.' --protocol=TCP --routines --no-create-info --skip-triggers '.$db.' > "'.$fileName.'"';
...
$instanceArray[0]['port'] = '3311';
$instanceArray[0]['folder'] = 'sql_data';
