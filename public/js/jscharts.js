...
I have modified this js to remove the water mark. - Naveen Agarwal(naveenagarwal287@gmail.com)
...
function mx() {
    ...
    this.fu = function () {
        ...
        //this.fw() // commented because it was overriding the container div
    };
    this.fw = function () {
        if (this.eA == false) {
            return
